...
static const string mainnet_seeds[] = {"dnsseed1.snowgem.org", "dnsseed2.snowgem.org", "dnsseed3.snowgem.org", "dnsseed.abctoxyz.site", ""};
static const string testnet_seeds[] = {"dnsseed.testnet.abctoxyz.site", ""};
